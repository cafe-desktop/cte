...
static const struct _vte_keymap_entry _vte_keymap_CDK_space[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_Tab[] = {
	/* Shift+Tab = Back-Tab */
...
static const struct _vte_keymap_entry _vte_keymap_CDK_Return[] = {
        {cursor_all, keypad_all, VTE_ALT_MASK, _VTE_CAP_ESC "\r", 2},
        {cursor_all, keypad_all, 0, "\r", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Escape[] = {
        {cursor_all, keypad_all, VTE_ALT_MASK, _VTE_CAP_ESC _VTE_CAP_ESC, 2},
        {cursor_all, keypad_all, 0, _VTE_CAP_ESC, 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Insert[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "2~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_ISO_Left_Tab[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "Z", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_slash[] = {
        {cursor_all, keypad_all, VTE_ALT_MASK, _VTE_CAP_ESC "/", 2},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_question[] = {
        {cursor_all, keypad_all, VTE_ALT_MASK, _VTE_CAP_ESC "?", 2},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_2[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\0", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_3[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\033", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_4[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\034", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_5[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\035", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_6[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\036", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_7[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\037", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_8[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\177", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};
static const struct _vte_keymap_entry _vte_keymap_CDK_Minus[] = {
        {cursor_all, keypad_all, CDK_CONTROL_MASK, "\037", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

/* Keys (potentially) affected by the cursor key mode. */
static const struct _vte_keymap_entry _vte_keymap_CDK_Home[] = {
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "H", -1},
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "H", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_End[] = {
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "F", -1},
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "F", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Page_Up[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "5~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Page_Down[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "6~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Up[] = {
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "A", -1},
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "A", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Down[] = {
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "B", -1},
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "B", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Right[] = {
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "C", -1},
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "C", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_Left[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Space[] = {
        {cursor_all, keypad_default, 0, " ", 1},
        {cursor_all, keypad_app, 0, _VTE_CAP_SS3 " ", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Tab[] = {
        {cursor_all, keypad_default, 0, "\t", 1},
        {cursor_all, keypad_app, 0, _VTE_CAP_SS3 "I", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Enter[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_F1[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_SS3 "P", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_F2[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_SS3 "Q", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_F3[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_SS3 "R", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_F4[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_SS3 "S", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Multiply[] = {
        {cursor_all, keypad_default, 0, "*", 1},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Add[] = {
        {cursor_all, keypad_default, 0, "+", 1},
        {cursor_all, keypad_app, VTE_NUMLOCK_MASK, "+", 1},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Separator[] = {
        {cursor_all, keypad_default, 0, ",", 1},
        {cursor_all, keypad_app, 0, _VTE_CAP_SS3 "l", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Subtract[] = {
        {cursor_all, keypad_default, 0, "-", 1},
        {cursor_all, keypad_app, VTE_NUMLOCK_MASK, "-", 1},
        {cursor_all, keypad_app, 0, _VTE_CAP_SS3 "m", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Decimal_Delete[] = {
        {cursor_all, keypad_default, 0, ".", 1},
        {cursor_all, keypad_app, 0, _VTE_CAP_SS3 "3~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Divide[] = {
        {cursor_all, keypad_default, 0, "/", 1},
        {cursor_all, keypad_app, VTE_NUMLOCK_MASK, "/", 1},
...
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_0[] = {
        {cursor_all, keypad_all, 0, "0", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_1[] = {
        {cursor_all, keypad_all, 0, "1", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_2[] = {
        {cursor_all, keypad_all, 0, "2", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_3[] = {
        {cursor_all, keypad_all, 0, "3", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_4[] = {
        {cursor_all, keypad_all, 0, "4", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_5[] = {
        {cursor_all, keypad_all, 0, "5", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_6[] = {
        {cursor_all, keypad_all, 0, "6", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_7[] = {
        {cursor_all, keypad_all, 0, "7", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_8[] = {
        {cursor_all, keypad_all, 0, "8", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_9[] = {
        {cursor_all, keypad_all, 0, "9", 1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

/* These are the same keys as above, but without numlock. */
static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Insert[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "2~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_End[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "F", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "F", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Down[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "B", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "B", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Page_Down[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "6~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Left[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "D", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "D", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Begin[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "E", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "E", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Right[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "C", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "C", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Home[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "H", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "H", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Up[] = {
        {cursor_app, keypad_all, 0, _VTE_CAP_SS3 "A", -1},
        {cursor_default, keypad_all, 0, _VTE_CAP_CSI "A", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_KP_Page_Up[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "5~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F1[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_F2[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_F3[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_F4[] = {
...
static const struct _vte_keymap_entry _vte_keymap_CDK_F5[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "15~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F6[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "17~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F7[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "18~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F8[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "19~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F9[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "20~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F10[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "21~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F11[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "23~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F12[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "24~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F13[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "25~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F14[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "26~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F15[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "28~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F16[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "29~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F17[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "31~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F18[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "32~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F19[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "33~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F20[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "34~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F21[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "42~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F22[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "43~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F23[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "44~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F24[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "45~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F25[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "46~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F26[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "47~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F27[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "48~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F28[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "49~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F29[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "50~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F30[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "51~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F31[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "52~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F32[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "53~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F33[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "54~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F34[] = {
        {cursor_all, keypad_all, 0, _VTE_CAP_CSI "55~", -1},
        {cursor_all, keypad_all, 0, X_NULL, 0},
};

static const struct _vte_keymap_entry _vte_keymap_CDK_F35[] = {
...
static const struct _vte_keymap_group {
	...
	{CDK_KEY_space,			_vte_keymap_CDK_space},
	{CDK_KEY_Return,		_vte_keymap_CDK_Return},
	{CDK_KEY_Escape,		_vte_keymap_CDK_Escape},
	{CDK_KEY_Tab,			_vte_keymap_CDK_Tab},
	{CDK_KEY_ISO_Left_Tab,		_vte_keymap_CDK_ISO_Left_Tab},
	{CDK_KEY_Home,			_vte_keymap_CDK_Home},
	{CDK_KEY_End,			_vte_keymap_CDK_End},
	{CDK_KEY_Insert,		_vte_keymap_CDK_Insert},
	{CDK_KEY_slash,			_vte_keymap_CDK_slash},
	{CDK_KEY_question,		_vte_keymap_CDK_question},
	/* CDK_Delete is all handled in code, due to funkiness. */
	{CDK_KEY_Page_Up,		_vte_keymap_CDK_Page_Up},
	{CDK_KEY_Page_Down,		_vte_keymap_CDK_Page_Down},

	{CDK_KEY_2,			_vte_keymap_CDK_2},
	{CDK_KEY_3,			_vte_keymap_CDK_3},
	{CDK_KEY_4,			_vte_keymap_CDK_4},
	{CDK_KEY_5,			_vte_keymap_CDK_5},
	{CDK_KEY_6,			_vte_keymap_CDK_6},
	{CDK_KEY_7,			_vte_keymap_CDK_7},
	{CDK_KEY_8,			_vte_keymap_CDK_8},
	{CDK_KEY_minus,			_vte_keymap_CDK_Minus},

	{CDK_KEY_Up,			_vte_keymap_CDK_Up},
	{CDK_KEY_Down,			_vte_keymap_CDK_Down},
	{CDK_KEY_Right,			_vte_keymap_CDK_Right},
	{CDK_KEY_Left,			_vte_keymap_CDK_Left},

	{CDK_KEY_KP_Space,		_vte_keymap_CDK_KP_Space},
	{CDK_KEY_KP_Tab,		_vte_keymap_CDK_KP_Tab},
	{CDK_KEY_KP_Enter,		_vte_keymap_CDK_KP_Enter},
	{CDK_KEY_KP_F1,			_vte_keymap_CDK_KP_F1},
	{CDK_KEY_KP_F2,			_vte_keymap_CDK_KP_F2},
	{CDK_KEY_KP_F3,			_vte_keymap_CDK_KP_F3},
	{CDK_KEY_KP_F4,			_vte_keymap_CDK_KP_F4},
	{CDK_KEY_KP_Multiply,		_vte_keymap_CDK_KP_Multiply},
	{CDK_KEY_KP_Add,		_vte_keymap_CDK_KP_Add},
	{CDK_KEY_KP_Separator,		_vte_keymap_CDK_KP_Separator},
	{CDK_KEY_KP_Subtract,		_vte_keymap_CDK_KP_Subtract},
	{CDK_KEY_KP_Decimal,		_vte_keymap_CDK_KP_Decimal_Delete},
	{CDK_KEY_KP_Delete,		_vte_keymap_CDK_KP_Decimal_Delete},
	{CDK_KEY_KP_Divide,		_vte_keymap_CDK_KP_Divide},
	{CDK_KEY_KP_0,			_vte_keymap_CDK_KP_0},
	{CDK_KEY_KP_Insert,		_vte_keymap_CDK_KP_Insert},
	{CDK_KEY_KP_1,			_vte_keymap_CDK_KP_1},
	{CDK_KEY_KP_End,		_vte_keymap_CDK_KP_End},
	{CDK_KEY_KP_2,			_vte_keymap_CDK_KP_2},
	{CDK_KEY_KP_Down,		_vte_keymap_CDK_KP_Down},
	{CDK_KEY_KP_3,			_vte_keymap_CDK_KP_3},
	{CDK_KEY_KP_Page_Down,		_vte_keymap_CDK_KP_Page_Down},
	{CDK_KEY_KP_4,			_vte_keymap_CDK_KP_4},
	{CDK_KEY_KP_Left,		_vte_keymap_CDK_KP_Left},
	{CDK_KEY_KP_5,			_vte_keymap_CDK_KP_5},
	{CDK_KEY_KP_Begin,		_vte_keymap_CDK_KP_Begin},
	{CDK_KEY_KP_6,			_vte_keymap_CDK_KP_6},
	{CDK_KEY_KP_Right,		_vte_keymap_CDK_KP_Right},
	{CDK_KEY_KP_7,			_vte_keymap_CDK_KP_7},
	{CDK_KEY_KP_Home,		_vte_keymap_CDK_KP_Home},
	{CDK_KEY_KP_8,			_vte_keymap_CDK_KP_8},
	{CDK_KEY_KP_Up,			_vte_keymap_CDK_KP_Up},
	{CDK_KEY_KP_9,			_vte_keymap_CDK_KP_9},
	{CDK_KEY_KP_Page_Up,		_vte_keymap_CDK_KP_Page_Up},

	{CDK_KEY_F1,			_vte_keymap_CDK_F1},
	{CDK_KEY_F2,			_vte_keymap_CDK_F2},
	{CDK_KEY_F3,			_vte_keymap_CDK_F3},
	{CDK_KEY_F4,			_vte_keymap_CDK_F4},
	{CDK_KEY_F5,			_vte_keymap_CDK_F5},
	{CDK_KEY_F6,			_vte_keymap_CDK_F6},
	{CDK_KEY_F7,			_vte_keymap_CDK_F7},
	{CDK_KEY_F8,			_vte_keymap_CDK_F8},
	{CDK_KEY_F9,			_vte_keymap_CDK_F9},
	{CDK_KEY_F10,			_vte_keymap_CDK_F10},
	{CDK_KEY_F11,			_vte_keymap_CDK_F11},
	{CDK_KEY_F12,			_vte_keymap_CDK_F12},
	{CDK_KEY_F13,			_vte_keymap_CDK_F13},
	{CDK_KEY_F14,			_vte_keymap_CDK_F14},
	{CDK_KEY_F15,			_vte_keymap_CDK_F15},
	{CDK_KEY_F16,			_vte_keymap_CDK_F16},
	{CDK_KEY_F17,			_vte_keymap_CDK_F17},
	{CDK_KEY_F18,			_vte_keymap_CDK_F18},
	{CDK_KEY_F19,			_vte_keymap_CDK_F19},
	{CDK_KEY_F20,			_vte_keymap_CDK_F20},
	{CDK_KEY_F21,			_vte_keymap_CDK_F21},
	{CDK_KEY_F22,			_vte_keymap_CDK_F22},
	{CDK_KEY_F23,			_vte_keymap_CDK_F23},
	{CDK_KEY_F24,			_vte_keymap_CDK_F24},
	{CDK_KEY_F25,			_vte_keymap_CDK_F25},
	{CDK_KEY_F26,			_vte_keymap_CDK_F26},
	{CDK_KEY_F27,			_vte_keymap_CDK_F27},
	{CDK_KEY_F28,			_vte_keymap_CDK_F28},
	{CDK_KEY_F29,			_vte_keymap_CDK_F29},
	{CDK_KEY_F30,			_vte_keymap_CDK_F30},
	{CDK_KEY_F31,			_vte_keymap_CDK_F31},
	{CDK_KEY_F32,			_vte_keymap_CDK_F32},
	{CDK_KEY_F33,			_vte_keymap_CDK_F33},
	{CDK_KEY_F34,			_vte_keymap_CDK_F34},
	{CDK_KEY_F35,			_vte_keymap_CDK_F35},
};
