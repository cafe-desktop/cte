...
#define VTE_DEFAULT_CURSOR		CDK_XTERM
#define VTE_MOUSING_CURSOR		CDK_LEFT_PTR
#define VTE_HYPERLINK_CURSOR		CDK_HAND2
#define VTE_HYPERLINK_CURSOR_DEBUG	CDK_SPIDER
